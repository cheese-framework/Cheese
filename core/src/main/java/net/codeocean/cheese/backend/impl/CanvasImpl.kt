...
import net.codeocean.cheese.core.GlobalActivity
...
object CanvasImpl :Canvas,BaseEnv {
    ...
    private  fun drawRectOnScreen(similarityText:String,textColor:Int,borderedColor:Int,left:Int,top:Int,right:Int,bottom:Int): EasyWindow<*> {
        ...
        println("*********************222222"+  globalVM.get<android.accessibilityservice.AccessibilityService>())
        println("*********************1111"+ GlobalActivity.getCurrentActivity())
        println("*********************1111"+ CoreFactory.getFloatingWindow().checkPermission())
